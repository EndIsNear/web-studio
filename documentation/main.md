...
TODO: пример и линк към долната глава
...
Това е финалният пример, който е и най-сложен. Той демонстрира как, със системата реализирана в тази дипломна работа, могат да се създадът примери за: ротация в 3д пространстовото и проекция на триизмерен куб в двуизмерно пространство - платното за рисуване. TODO обяснение
