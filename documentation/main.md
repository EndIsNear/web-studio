...
1. Инициализация на масив (Init array)
2. Четене на големината на масив (Read array size)
3. Четена на число от масив (Read array num)
4. Писане на число в масив (Write array num)
5. Добавяне на число накрая (Push back num)
...
2. Рисуване на линия (Draw line)
3. Рисуване на кръг (Draw circle)
4. Изчистване на правоъгълник (Clear rectangle)
